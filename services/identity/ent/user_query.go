...
func (_q *UserQuery) QueryCredential() *CredentialQuery {
...
func (_q *UserQuery) WithCredential(opts ...func(*CredentialQuery)) *UserQuery {
	query := (&CredentialClient{config: _q.config}).Query()
...
func (_q *UserQuery) loadCredential(ctx context.Context, query *CredentialQuery, nodes []*User, init func(*User), assign func(*User, *Credential)) error {
