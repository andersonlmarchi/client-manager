...
func (_u *UserUpdate) SetCredentialID(id string) *UserUpdate {
...
func (_u *UserUpdate) SetNillableCredentialID(id *string) *UserUpdate {
	if id != nil {
...
// SetCredentialID sets the "credential" edge to the Credential entity by ID.
func (_u *UserUpdateOne) SetCredentialID(id string) *UserUpdateOne {
	_u.mutation.SetCredentialID(id)
	return _u
}

// SetNillableCredentialID sets the "credential" edge to the Credential entity by ID if the given value is not nil.
func (_u *UserUpdateOne) SetNillableCredentialID(id *string) *UserUpdateOne {
	if id != nil {
		_u = _u.SetCredentialID(*id)
	}
	return _u
